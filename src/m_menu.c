...
setup_menu_t stat_settings1[] =  // Status Bar and HUD Settings screen
{
  ...
  {"MAXIMUM VALUE FOR HUD BAR",S_CHOICE,m_null,SB_X,SB_Y+7*8,
  ...
  {"COLOR ARMOR BY TYPE NOT AMOUNT",S_YESNO,m_null,SB_X,SB_Y+11*8,
   {"armor_color_behavior"}},
  {"ARMOR LOW/OK"      ,S_NUM       ,m_null,SB_X,SB_Y+12*8, {"armor_red"}},
  {"ARMOR OK/GOOD"     ,S_NUM       ,m_null,SB_X,SB_Y+13*8, {"armor_yellow"}},
  {"ARMOR GOOD/EXTRA"  ,S_NUM       ,m_null,SB_X,SB_Y+14*8, {"armor_green"}},
  ...
  {"BACKPACK CHANGES THRESHOLDS",S_CHOICE,m_null,SB_X,SB_Y+17*8, 
   {"ammo_color_behavior"},0,0,NULL,ammo_color_behavior_list},
